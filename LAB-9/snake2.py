...
def gameLoop():
    ...
    foodx1 = round(random.randrange(0, dis_width - snake_block) / 10.0) * 10.0
    foody1 = round(random.randrange(0, dis_height - snake_block) / 10.0) * 10.0
    ...
    while not game_over:
        ...
        pygame.draw.rect(dis, white, [foodx1, foody1, snake_block, snake_block])
